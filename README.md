...
![Modern SQL HTML Email Alert For Drive Space]( https://mikesdatawork.files.wordpress.com/2020/08/image001-1.png "Modern SQL HTML Email Alert For Drive Space")
